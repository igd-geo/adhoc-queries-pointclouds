...
use lz4::Decoder;
use pasture_core::{containers::{PerAttributeVecPointStorage, PointBufferWriteable}, layout::{PointLayout, attributes::{CLASSIFICATION, COLOR_RGB, INTENSITY, POSITION_3D}, conversion::{AttributeConversionFn, get_converter_for_attributes}}, nalgebra::Vector3, util::view_raw_bytes};
...
impl PointReader for LAZERSource {
    fn read_into(
        ...
        let target_layout = point_buffer.point_layout();
